...
It's also important to note that this configuration makes heavy use of the brilliant [[https://github.com/jwiegley/use-package][use-pkg]].  
See ~init.el~ for the ~use-pkg~ bootstrapping code.
* Common
** General
Personal stuff
