...
** Ivy/Counsel/Swiper
   ...
   Ivy settings:
   - Add recent files & bookmarks to buffer switch list
...
** [[https://github.com/bbatsov/projectile][Projectile]]
   ...
   - Binding ~C-c p p~ to use ~perspective~'s projectile switch function to integrate the two
   #+begin_src emacs-lisp
...
** [[https://github.com/stuartsierra/password-store/blob/master/contrib/emacs/password-store.el][password-store]]
