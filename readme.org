...
** [[https://github.com/nex3/perspective-el][Perspective]]
   ...
   Here, I've defined a ~persp-neo~ function for use with ~persp-switch-hook~. This makes NeoTree follow the perspective when switching.
...
** Modeline
   ...
   I've specifically set the ~spaceline-highlight-face~ background to match the light blue used in the ~doom-one~ theme.
   #+begin_src emacs-lisp
