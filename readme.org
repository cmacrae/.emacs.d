...
** [[https://github.com/bbatsov/projectile][Projectile]]
   ...
   - Custom function for switching buffers based on status of current project:
     If I'm in a project and I do ~C-x b~, it calls ~counsel-projectile-switch-to-buffer~.
     If I'm not in a project, it falls back to ~ivy-switch-buffer~.
